...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "33", change: "+3%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "6", change: "+1%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "11", change: "+3%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "16", change: "+6%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "1.4d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in Big Bazaar Street", status: "Open" },
    { desc: "Sewage overflow in Thirugokarnam", status: "In Progress" },
    { desc: "Pothole on main road in Pudukkottai Road", status: "Resolved" },
    { desc: "No water supply in Melaiyur", status: "Open" }
];

export default function DBMC21() {
