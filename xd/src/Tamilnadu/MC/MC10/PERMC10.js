...
const kpis = [
    { label: 'SLA Compliance', value: '88.9%', change: '+0.1%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.6 hrs', change: '+0.3 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.2/5', change: '-0.2', trend: 'positive' },
    { label: 'Resolution Rate', value: '84.6%', change: '+0.4%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Dindigul Electric', score: '97.2%' },
    { rank: 2, name: 'Dindigul Water Board', score: '96.5%' },
    { rank: 3, name: 'Dindigul Sanitation', score: '95.8%' },
    { rank: 4, name: 'Dindigul Roads', score: '94.2%' },
    { rank: 5, name: 'Dindigul PWD', score: '93.5%' },
];

export default function PERMC10() {
