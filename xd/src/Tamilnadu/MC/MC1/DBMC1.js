...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "55", change: "+9%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "12", change: "+4%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "20", change: "+5%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "23", change: "+12%", changeColor: "#15bd60", className: "mc-resolved" },
...
const recentComplaints = [
    ...
    { desc: "Sewage overflow in T. Nagar", status: "In Progress" },
    { desc: "Pothole on main road in Velachery", status: "Resolved" },
    { desc: "No water supply in Adyar", status: "Open" },
];
