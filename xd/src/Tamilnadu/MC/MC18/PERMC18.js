...
const kpis = [
    { label: 'SLA Compliance', value: '96.5%', change: '+1.8%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.6 hrs', change: '-0.4 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.9/5', change: '+0.3', trend: 'positive' },
    { label: 'Resolution Rate', value: '92.0%', change: '+1.7%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Hosur Electric', score: '97.2%' },
    { rank: 2, name: 'Hosur Water Board', score: '96.5%' },
    { rank: 3, name: 'Hosur Sanitation', score: '95.8%' },
    { rank: 4, name: 'Hosur Roads', score: '94.2%' },
    { rank: 5, name: 'Hosur PWD', score: '93.5%' },
];

export default function PERMC18() {
