...
const kpis = [
    { label: 'SLA Compliance', value: '93.6%', change: '+1.1%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.0 hrs', change: '-0.1 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.5/5', change: '+0.1', trend: 'positive' },
    { label: 'Resolution Rate', value: '88.7%', change: '+0.8%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Pudukottai Electric', score: '97.2%' },
    { rank: 2, name: 'Pudukottai Water Board', score: '96.5%' },
    { rank: 3, name: 'Pudukottai Sanitation', score: '95.8%' },
    { rank: 4, name: 'Pudukottai Roads', score: '94.2%' },
    { rank: 5, name: 'Pudukottai PWD', score: '93.5%' },
];

export default function PERMC21() {
