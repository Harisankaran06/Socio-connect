...
const departmentPerformance = [
    { name: 'Sanitation', resolved: 4, total: 6, satisfaction: 89, icon: 'cleaning_services', color: '#28c940', progressClass: 'pb-san' },
    { name: 'PWD', resolved: 4, total: 5, satisfaction: 86, icon: 'engineering', color: '#16aaff', progressClass: 'pb-pwd' },
    { name: 'Electricity', resolved: 3, total: 4, satisfaction: 92, icon: 'bolt', color: '#ffb300', progressClass: 'pb-elec' },
    { name: 'Water Supply', resolved: 5, total: 8, satisfaction: 80, icon: 'water_drop', color: '#ff792a', progressClass: 'pb-water' },
    { name: 'Roads', resolved: 4, total: 6, satisfaction: 83, icon: 'add_road', color: '#5e35b1', progressClass: 'pb-road' },
];
...
export default function ANAMC24() {
