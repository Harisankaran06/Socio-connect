...
const departmentPerformance = [
    { name: 'Sanitation', resolved: 10, total: 14, satisfaction: 89, icon: 'cleaning_services', color: '#28c940', progressClass: 'pb-san' },
    { name: 'PWD', resolved: 6, total: 8, satisfaction: 86, icon: 'engineering', color: '#16aaff', progressClass: 'pb-pwd' },
    { name: 'Electricity', resolved: 7, total: 9, satisfaction: 92, icon: 'bolt', color: '#ffb300', progressClass: 'pb-elec' },
...
export default function ANAMC7() {
