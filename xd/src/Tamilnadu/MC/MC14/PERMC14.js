...
const kpis = [
    { label: 'SLA Compliance', value: '90.5%', change: '+0.6%', trend: 'positive' },
    ...
    { label: 'Resolution Rate', value: '86.8%', change: '+1.0%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Karur Electric', score: '97.2%' },
    { rank: 2, name: 'Karur Water Board', score: '96.5%' },
    { rank: 3, name: 'Karur Sanitation', score: '95.8%' },
    { rank: 4, name: 'Karur Roads', score: '94.2%' },
    { rank: 5, name: 'Karur PWD', score: '93.5%' },
];

export default function PERMC14() {
