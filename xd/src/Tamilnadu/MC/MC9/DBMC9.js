...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "38", change: "+5%", changeColor: "#15bd60", className: "mc-total" },
  ...
  { icon: "check_circle", title: "Resolved", value: "18", change: "+9%", changeColor: "#15bd60", className: "mc-resolved" },
...
const recentComplaints = [
    { desc: "Street light not working in Millerpuram", status: "Open" },
    { desc: "Sewage overflow in Roche Park", status: "In Progress" },
    { desc: "Pothole on main road in VVD area", status: "Resolved" },
    { desc: "No water supply in Korampallam", status: "Open" }
];

export default function DBMC9() {
