...
const kpis = [
    { label: 'SLA Compliance', value: '97.1%', change: '+2.1%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.6 hrs', change: '-0.5 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.9/5', change: '+0.4', trend: 'positive' },
    { label: 'Resolution Rate', value: '91.3%', change: '+1.8%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Tiruppur Electric', score: '97.2%' },
    { rank: 2, name: 'Tiruppur Water Board', score: '96.5%' },
    { rank: 3, name: 'Tiruppur Sanitation', score: '95.8%' },
    { rank: 4, name: 'Tiruppur Roads', score: '94.2%' },
    { rank: 5, name: 'Tiruppur PWD', score: '93.5%' },
];

export default function PERMC8() {
