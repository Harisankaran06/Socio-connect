...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "42", change: "+7%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "8", change: "+2%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "15", change: "+3%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "19", change: "+8%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "1.8d", change: "-0.3d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in RS Puram", status: "Open" },
    { desc: "Sewage overflow in Gandhipuram", status: "In Progress" },
    { desc: "Pothole on main road in Peelamedu", status: "Resolved" },
    { desc: "No water supply in Saibaba Colony", status: "Open" },
];

export default function DBMC2() {
