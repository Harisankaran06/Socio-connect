...
export default function PWDDepartment() {
  ...
  const fetchPWDComplaints = async () => {
    try {
      ...
      console.log('🏢 PWD Dept - API Response:', response);
      ...
      if (response && response.success && response.data) {
        ...
        console.log('🏗️ Filtered PWD Complaints:', pwdComplaints);
      ...
      console.error('🚨 Error fetching PWD complaints:', err);
    ...
    return (
      <>
        ...
        <main className="main-content">
          <div className="loading">🏗️ Loading PWD Department data...</div>
        </main>
      </>
    );
  }
