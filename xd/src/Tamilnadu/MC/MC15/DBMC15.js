...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "63", change: "+10%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "12", change: "+5%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "22", change: "+8%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "29", change: "+14%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.3d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in Beach Road", status: "Open" },
    { desc: "Sewage overflow in Kottar", status: "In Progress" },
    { desc: "Pothole on main road in Palayamkottai Road", status: "Resolved" },
    { desc: "No water supply in Vadassery", status: "Open" }
];

export default function DBMC15() {
