...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "73", change: "+13%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "16", change: "+7%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "28", change: "+10%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "29", change: "+12%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.5d", change: "-0.3d", changeColor: "#15bd60", className: "mc-avg" },
  { icon: "error", title: "Overdue", value: "6", change: "+1", changeColor: "#e03434", className: "mc-overdue" }
];
...
const recentComplaints = [
    { desc: "Street light not working in Cantonment", status: "Open" },
    { desc: "Sewage overflow in Thillai Nagar", status: "In Progress" },
    { desc: "Pothole on main road in K.K. Nagar", status: "Resolved" },
    { desc: "No water supply in Srirangam", status: "Open" },
];

export default function DBMC4() {
