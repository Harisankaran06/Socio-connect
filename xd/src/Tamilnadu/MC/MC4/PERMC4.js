...
const kpis = [
    { label: 'SLA Compliance', value: '91.3%', change: '+0.5%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.4 hrs', change: '+0.1 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.4/5', change: '-0.1', trend: 'positive' },
    { label: 'Resolution Rate', value: '87.8%', change: '+1.5%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Trichy Electric', score: '97.2%' },
    { rank: 2, name: 'Trichy Water Board', score: '96.5%' },
    { rank: 3, name: 'Trichy Sanitation', score: '95.8%' },
    { rank: 4, name: 'Trichy Roads', score: '94.2%' },
    { rank: 5, name: 'Trichy PWD', score: '93.5%' },
];

export default function PERMC4() {
