...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "71", change: "+12%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "15", change: "+6%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "26", change: "+9%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "30", change: "+15%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.4d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
  { icon: "error", title: "Overdue", value: "7", change: "+1", changeColor: "#e03434", className: "mc-overdue" }
];
...
const recentComplaints = [
    { desc: "Street light not working in Dindigul Road", status: "Open" },
    { desc: "Sewage overflow in Begumpur", status: "In Progress" },
    { desc: "Pothole on main road in Red Hills", status: "Resolved" },
    { desc: "No water supply in Chinnakadai", status: "Open" }
];

export default function DBMC10() {
