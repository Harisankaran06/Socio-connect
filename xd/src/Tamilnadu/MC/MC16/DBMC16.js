...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "57", change: "+8%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "11", change: "+4%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "20", change: "+7%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "26", change: "+12%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "1.9d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
  { icon: "error", title: "Overdue", value: "4", change: "+1", changeColor: "#e03434", className: "mc-overdue" }
];
...
const recentComplaints = [
    { desc: "Street light not working in Gandhi Road", status: "Open" },
    { desc: "Sewage overflow in Nellikuppam", status: "In Progress" },
    { desc: "Pothole on main road in Perumal Koil Street", status: "Resolved" },
    { desc: "No water supply in Varadarajapuram", status: "Open" }
];

export default function DBMC16() {
