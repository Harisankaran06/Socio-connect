...
const kpis = [
    { label: 'SLA Compliance', value: '92.1%', change: '+0.8%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.2 hrs', change: '-0.1 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.5/5', change: '+0.2', trend: 'positive' },
    { label: 'Resolution Rate', value: '86.3%', change: '+1.2%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Coimbatore Electric', score: '97.2%' },
    { rank: 2, name: 'Coimbatore Water Board', score: '96.5%' },
    { rank: 3, name: 'Coimbatore Sanitation', score: '95.8%' },
    { rank: 4, name: 'Coimbatore Roads', score: '94.2%' },
    { rank: 5, name: 'Coimbatore PWD', score: '93.5%' },
];

export default function PERMC2() {
