...
const kpis = [
    { label: 'SLA Compliance', value: '91.8%', change: '+0.7%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.2 hrs', change: '+0.1 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.3/5', change: '-0.1', trend: 'positive' },
    { label: 'Resolution Rate', value: '87.1%', change: '+1.4%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Avadi Electric', score: '97.2%' },
    { rank: 2, name: 'Avadi Water Board', score: '96.5%' },
    { rank: 3, name: 'Avadi Sanitation', score: '95.8%' },
    { rank: 4, name: 'Avadi Roads', score: '94.2%' },
    { rank: 5, name: 'Avadi PWD', score: '93.5%' },
];

export default function PERMC17() {
