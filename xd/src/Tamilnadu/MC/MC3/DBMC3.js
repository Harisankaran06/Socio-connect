...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "67", change: "+11%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "14", change: "+6%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "23", change: "+8%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "30", change: "+15%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.1d", change: "-0.1d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    ...
    { desc: "Sewage overflow in Goripalayam", status: "In Progress" },
    { desc: "Pothole on main road in K.K. Nagar", status: "Resolved" },
    { desc: "No water supply in SS Colony", status: "Open" },
];

export default function DBMC3() {
