...
const kpis = [
    { label: 'SLA Compliance', value: '89.4%', change: '+0.3%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.5 hrs', change: '+0.2 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.3/5', change: '0', trend: 'positive' },
    { label: 'Resolution Rate', value: '85.7%', change: '+0.9%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Erode Electric', score: '97.2%' },
    { rank: 2, name: 'Erode Water Board', score: '96.5%' },
    { rank: 3, name: 'Erode Sanitation', score: '95.8%' },
    { rank: 4, name: 'Erode Roads', score: '94.2%' },
    { rank: 5, name: 'Erode PWD', score: '93.5%' },
];

export default function PERMC7() {
