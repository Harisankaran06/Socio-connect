...
const kpis = [
    { label: 'SLA Compliance', value: '92.5%', change: '+0.8%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.5 hrs', change: '-0.1 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.5/5', change: '+0.2', trend: 'positive' },
    { label: 'Resolution Rate', value: '85.5%', change: '-1.2%', trend: 'negative' },
];

const trends = [
    { month: 'September', csat: '4.5/5', resolution: '85.5%' },
    { month: 'August', csat: '4.3/5', resolution: '86.7%' },
    { month: 'July', csat: '4.2/5', resolution: '85.2%' },
    { month: 'June', csat: '4.1/5', resolution: '84.9%' },
    { month: 'May', csat: '4.0/5', resolution: '83.5%' },
];

const leaderboard = [
    { rank: 1, name: 'Ranchi Electric', score: '95.8%' },
    { rank: 2, name: 'Ranchi Water Board', score: '94.2%' },
    { rank: 3, name: 'Ranchi Sanitation', score: '93.5%' },
    { rank: 4, name: 'Ranchi Roads', score: '92.1%' },
    { rank: 5, name: 'Ranchi PWD', score: '90.8%' },
];

export default function PERJK() {
