...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "61", change: "+9%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "13", change: "+7%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "21", change: "+7%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "27", change: "+13%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.2d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
  { icon: "error", title: "Overdue", value: "5", change: "+1", changeColor: "#e03434", className: "mc-overdue" }
];
...
const recentComplaints = [
    { desc: "Street light not working in Perundurai Road", status: "Open" },
    { desc: "Sewage overflow in GH area", status: "In Progress" },
    { desc: "Pothole on main road in Rangampalayam", status: "Resolved" },
    { desc: "No water supply in Veerappanchatram", status: "Open" }
];

export default function DBMC7() {
