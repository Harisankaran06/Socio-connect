...
const kpis = [
    { label: 'SLA Compliance', value: '93.2%', change: '+1.0%', trend: 'positive' },
    ...
    { label: 'Resolution Rate', value: '88.3%', change: '+0.5%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Nagercoil Electric', score: '97.2%' },
    { rank: 2, name: 'Nagercoil Water Board', score: '96.5%' },
    { rank: 3, name: 'Nagercoil Sanitation', score: '95.8%' },
    { rank: 4, name: 'Nagercoil Roads', score: '94.2%' },
    { rank: 5, name: 'Nagercoil PWD', score: '93.5%' },
];

export default function PERMC15() {
