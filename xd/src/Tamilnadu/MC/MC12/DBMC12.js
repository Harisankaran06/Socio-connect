...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "52", change: "+7%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "11", change: "+4%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "18", change: "+6%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "23", change: "+11%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.1d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in Anna Nagar", status: "Open" },
    { desc: "Sewage overflow in East Main Street", status: "In Progress" },
    { desc: "Pothole on main road in Medical College Road", status: "Resolved" },
    { desc: "No water supply in Vallam", status: "Open" }
];

export default function DBMC12() {
