...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "35", change: "+4%", changeColor: "#15bd60", className: "mc-total" },
  ...
  { icon: "check_circle", title: "Resolved", value: "17", change: "+7%", changeColor: "#15bd60", className: "mc-resolved" },
...
const recentComplaints = [
    { desc: "Street light not working in Ayyampalayam", status: "Open" },
    { desc: "Sewage overflow in Vellalar Street", status: "In Progress" },
    { desc: "Pothole on main road in Pasumpon Nagar", status: "Resolved" },
    { desc: "No water supply in Mayanur", status: "Open" }
];

export default function DBMC14() {
