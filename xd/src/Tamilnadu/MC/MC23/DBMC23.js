...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "37", change: "+4%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "7", change: "+2%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "12", change: "+3%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "18", change: "+7%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "1.5d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in Market Street", status: "Open" },
    { desc: "Sewage overflow in Pillaiyarpatty", status: "In Progress" },
    { desc: "Pothole on main road in Devakottai Road", status: "Resolved" },
    { desc: "No water supply in Sivaganga Road", status: "Open" }
];

export default function DBMC23() {
