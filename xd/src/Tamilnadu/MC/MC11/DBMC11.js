...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "46", change: "+6%", changeColor: "#15bd60", className: "mc-total" },
...
const recentComplaints = [
    { desc: "Street light not working in Gandhi Nagar", status: "Open" },
    { desc: "Sewage overflow in Katpadi", status: "In Progress" },
    { desc: "Pothole on main road in Salavanpet", status: "Resolved" },
    { desc: "No water supply in Officer's Line", status: "Open" }
];

export default function DBMC11() {
