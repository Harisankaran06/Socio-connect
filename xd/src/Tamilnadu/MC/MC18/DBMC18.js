...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "41", change: "+5%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "8", change: "+2%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "14", change: "+4%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "19", change: "+8%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "1.7d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in Sipcot", status: "Open" },
    { desc: "Sewage overflow in Mathur", status: "In Progress" },
    { desc: "Pothole on main road in Bagalur", status: "Resolved" },
    { desc: "No water supply in Electronics City", status: "Open" }
];

export default function DBMC18() {
