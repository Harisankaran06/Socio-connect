...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "58", change: "+8%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "11", change: "+3%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "19", change: "+6%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "28", change: "+14%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.0d", change: "-0.4d", changeColor: "#15bd60", className: "mc-avg" },
  { icon: "error", title: "Overdue", value: "4", change: "+2", changeColor: "#e03434", className: "mc-overdue" }
];
...
const recentComplaints = [
    { desc: "Street light not working in Suramangalam", status: "Open" },
    { desc: "Sewage overflow in Fairlands", status: "In Progress" },
    { desc: "Pothole on main road in Ammapet", status: "Resolved" },
    { desc: "No water supply in Hasthampatti", status: "Open" }
];

export default function DBMC5() {
