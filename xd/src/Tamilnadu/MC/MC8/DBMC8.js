...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "54", change: "+7%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "10", change: "+3%", changeColor: "#e1861e", className: "mc-open" },
  ...
  { icon: "trending_up", title: "Avg Resolution", value: "1.7d", change: "-0.6d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in Kumaran Nagar", status: "Open" },
    { desc: "Sewage overflow in Veerapandi", status: "In Progress" },
    { desc: "Pothole on main road in Dharapuram Road", status: "Resolved" },
    { desc: "No water supply in Avinashi Road", status: "Open" }
];

export default function DBMC8() {
