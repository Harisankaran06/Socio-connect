...
const kpis = [
    { label: 'SLA Compliance', value: '97.3%', change: '+2.2%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.4 hrs', change: '-0.7 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.9/5', change: '+0.4', trend: 'positive' },
    { label: 'Resolution Rate', value: '92.4%', change: '+1.9%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Namakkal Electric', score: '97.2%' },
    { rank: 2, name: 'Namakkal Water Board', score: '96.5%' },
    { rank: 3, name: 'Namakkal Sanitation', score: '95.8%' },
    { rank: 4, name: 'Namakkal Roads', score: '94.2%' },
    { rank: 5, name: 'Namakkal PWD', score: '93.5%' },
];

export default function PERMC22() {
