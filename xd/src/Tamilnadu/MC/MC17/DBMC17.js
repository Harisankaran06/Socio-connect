...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "48", change: "+6%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "9", change: "+3%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "17", change: "+5%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "22", change: "+10%", changeColor: "#15bd60", className: "mc-resolved" },
...
const recentComplaints = [
    { desc: "Street light not working in Poonamallee High Road", status: "Open" },
    { desc: "Sewage overflow in CTH Road", status: "In Progress" },
    { desc: "Pothole on main road in Kamdar Nagar", status: "Resolved" },
    { desc: "No water supply in Venkatapuram", status: "Open" }
];

export default function DBMC17() {
