...
const kpis = [
    { label: 'SLA Compliance', value: '94.1%', change: '+1.2%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.9 hrs', change: '-0.2 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.6/5', change: '+0.1', trend: 'positive' },
    { label: 'Resolution Rate', value: '89.6%', change: '+0.9%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Kanchipuram Electric', score: '97.2%' },
    { rank: 2, name: 'Kanchipuram Water Board', score: '96.5%' },
    { rank: 3, name: 'Kanchipuram Sanitation', score: '95.8%' },
    { rank: 4, name: 'Kanchipuram Roads', score: '94.2%' },
    { rank: 5, name: 'Kanchipuram PWD', score: '93.5%' },
];

export default function PERMC16() {
