...
const departmentPerformance = [
    { name: 'Sanitation', resolved: 9, total: 13, satisfaction: 89, icon: 'cleaning_services', color: '#28c940', progressClass: 'pb-san' },
    ...
    { name: 'Water Supply', resolved: 10, total: 15, satisfaction: 80, icon: 'water_drop', color: '#ff792a', progressClass: 'pb-water' },
    { name: 'Roads', resolved: 9, total: 12, satisfaction: 83, icon: 'add_road', color: '#5e35b1', progressClass: 'pb-road' },
];
...
export default function ANAMC16() {
