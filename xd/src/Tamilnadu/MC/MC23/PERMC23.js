...
const kpis = [
    { label: 'SLA Compliance', value: '90.2%', change: '+0.5%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.3 hrs', change: '0', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.4/5', change: '+0.1', trend: 'positive' },
    { label: 'Resolution Rate', value: '86.5%', change: '+1.1%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Karaikudi Electric', score: '97.2%' },
    { rank: 2, name: 'Karaikudi Water Board', score: '96.5%' },
    { rank: 3, name: 'Karaikudi Sanitation', score: '95.8%' },
    { rank: 4, name: 'Karaikudi Roads', score: '94.2%' },
    { rank: 5, name: 'Karaikudi PWD', score: '93.5%' },
];

export default function PERMC23() {
