...
const kpis = [
    { label: 'SLA Compliance', value: '93.8%', change: '+1.1%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.9 hrs', change: '-0.2 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.6/5', change: '+0.3', trend: 'positive' },
    { label: 'Resolution Rate', value: '88.9%', change: '+0.6%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Salem Electric', score: '97.2%' },
    { rank: 2, name: 'Salem Water Board', score: '96.5%' },
    { rank: 3, name: 'Salem Sanitation', score: '95.8%' },
    { rank: 4, name: 'Salem Roads', score: '94.2%' },
    { rank: 5, name: 'Salem PWD', score: '93.5%' },
];

export default function PERMC5() {
