...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "44", change: "+5%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "9", change: "+3%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "15", change: "+5%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "20", change: "+9%", changeColor: "#15bd60", className: "mc-resolved" },
...
const recentComplaints = [
    { desc: "Street light not working in Manjakuppam", status: "Open" },
    { desc: "Sewage overflow in Thirupapuliyur", status: "In Progress" },
    { desc: "Pothole on main road in Devanampattinam", status: "Resolved" },
    { desc: "No water supply in Panruti Road", status: "Open" }
];

export default function DBMC13() {
