...
const departmentPerformance = [
    { name: 'Sanitation', resolved: 8, total: 10, satisfaction: 90, icon: 'cleaning_services', color: '#28c940', progressClass: 'pb-san' },
    { name: 'PWD', resolved: 4, total: 5, satisfaction: 85, icon: 'engineering', color: '#16aaff', progressClass: 'pb-pwd' },
    { name: 'Electricity', resolved: 16, total: 20, satisfaction: 88, icon: 'bolt', color: '#ffb300', progressClass: 'pb-elec' },
    { name: 'Water Supply', resolved: 12, total: 15, satisfaction: 75, icon: 'water_drop', color: '#ff792a', progressClass: 'pb-water' },
    { name: 'Roads', resolved: 5, total: 8, satisfaction: 80, icon: 'add_road', color: '#5e35b1', progressClass: 'pb-road' },
];

const summary = {
    bestPerformer: 'Sanitation',
    needsImprovement: 'Water Supply'
};

export default function ANAJK() {
...
<td>{`${d.satisfaction}%`}</td>
        ...
        <div className="grid-2-col">
          <div className="card">
            ...
            <ul className="list">
              <li className="list-item"><span className="list-item-label">1. Harmu</span> <span className="list-item-value">55 cases</span></li>
              <li className="list-item"><span className="list-item-label">2. Lalpur</span> <span className="list-item-value">42 cases</span></li>
              <li className="list-item"><span className="list-item-label">3. Kanke</span> <span className="list-item-value">35 cases</span></li>
              <li className="list-item"><span className="list-item-label">4. Doranda</span> <span className="list-item-value">31 cases</span></li>
            </ul>
          </div>
          <div className="card">
            <div className="card-title">
            ...
            <ul className="list">
              <li className="list-item"><span className="list-item-label">Under 24 hours</span> <span className="list-item-value">40%</span></li>
              <li className="list-item"><span className="list-item-label">1-3 days</span> <span className="list-item-value">38%</span></li>
              <li className="list-item"><span className="list-item-label">3-7 days</span> <span className="list-item-value">18%</span></li>
              <li className="list-item"><span className="list-item-label">Over 7 days</span> <span className="list-item-value">4%</span></li>
            </ul>
          </div>
        </div>
      </div>
