...
const kpis = [
    { label: 'SLA Compliance', value: '95.7%', change: '+1.5%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.8 hrs', change: '-0.3 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.7/5', change: '+0.1', trend: 'positive' },
    { label: 'Resolution Rate', value: '89.4%', change: '+0.8%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Madurai Electric', score: '97.2%' },
    { rank: 2, name: 'Madurai Water Board', score: '96.5%' },
    { rank: 3, name: 'Madurai Sanitation', score: '95.8%' },
    { rank: 4, name: 'Madurai Roads', score: '94.2%' },
    { rank: 5, name: 'Madurai PWD', score: '93.5%' },
];

export default function PERMC3() {
