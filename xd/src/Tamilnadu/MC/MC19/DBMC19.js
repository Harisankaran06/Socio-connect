...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "39", change: "+4%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "7", change: "+2%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "13", change: "+4%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "19", change: "+8%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "1.6d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
  { icon: "error", title: "Overdue", value: "2", change: "+1", changeColor: "#e03434", className: "mc-overdue" }
];
...
const recentComplaints = [
    { desc: "Street light not working in Thanjavur Road", status: "Open" },
    { desc: "Sewage overflow in Sarangapani Street", status: "In Progress" },
    { desc: "Pothole on main road in TSR Big Street", status: "Resolved" },
    { desc: "No water supply in Darasuram Road", status: "Open" }
];

export default function DBMC19() {
