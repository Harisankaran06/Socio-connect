...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "51", change: "+7%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "9", change: "+3%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "18", change: "+6%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "24", change: "+11%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.0d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in Chengam Road", status: "Open" },
    { desc: "Sewage overflow in Polur", status: "In Progress" },
    { desc: "Pothole on main road in Vandavasi Road", status: "Resolved" },
    { desc: "No water supply in Arani", status: "Open" }
];

export default function DBMC25() {
