...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "49", change: "+6%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "9", change: "+2%", changeColor: "#e1861e", className: "mc-open" },
  ...
  { icon: "trending_up", title: "Avg Resolution", value: "1.9d", change: "-0.5d", changeColor: "#15bd60", className: "mc-avg" },
...
const recentComplaints = [
    { desc: "Street light not working in Palayamkottai", status: "Open" },
    { desc: "Sewage overflow in Melapalayam", status: "In Progress" },
    { desc: "Pothole on main road in Town area", status: "Resolved" },
    { desc: "No water supply in Vannarpet", status: "Open" }
];

export default function DBMC6() {
