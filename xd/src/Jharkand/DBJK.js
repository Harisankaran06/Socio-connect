...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "58", change: "+12%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "15", change: "+5%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "18", change: "+8%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "25", change: "+15%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "2.8d", change: "-0.1d", changeColor: "#15bd60", className: "mc-avg" },
  { icon: "error", title: "Overdue", value: "5", change: "+3", changeColor: "#e03434", className: "mc-overdue" }
];

const categories = [
    { label: "Electricity", value: 20, color: "#ffb300" },
    { label: "Water Supply", value: 15, color: "#16aaff" },
    { label: "Sanitation", value: 10, color: "#28c940" },
    { label: "Roads", value: 8, color: "#ff792a" },
    { label: "PWD", value: 5, color: "#5e35b1" },
];

const recentComplaints = [
    { desc: "Street light not working in Harmu, Ranchi", status: "Open" },
    { desc: "Sewage overflow in Lalpur, Ranchi", status: "In Progress" },
    { desc: "Pothole on main road in Kanke, Ranchi", status: "Resolved" },
    { desc: "No water supply in Doranda, Ranchi", status: "Open" },
];

export default function DBJK() {
