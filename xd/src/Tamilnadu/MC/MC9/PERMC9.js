...
const kpis = [
    { label: 'SLA Compliance', value: '94.8%', change: '+1.3%', trend: 'positive' },
    ...
    { label: 'Resolution Rate', value: '89.2%', change: '+0.7%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Thoothukudi Electric', score: '97.2%' },
    { rank: 2, name: 'Thoothukudi Water Board', score: '96.5%' },
    { rank: 3, name: 'Thoothukudi Sanitation', score: '95.8%' },
    { rank: 4, name: 'Thoothukudi Roads', score: '94.2%' },
    { rank: 5, name: 'Thoothukudi PWD', score: '93.5%' },
];

export default function PERMC9() {
