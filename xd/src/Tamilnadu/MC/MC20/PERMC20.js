...
const kpis = [
    { label: 'SLA Compliance', value: '95.9%', change: '+1.6%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.7 hrs', change: '-0.3 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.8/5', change: '+0.2', trend: 'positive' },
    { label: 'Resolution Rate', value: '90.8%', change: '+1.2%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Tambaram Electric', score: '97.2%' },
    { rank: 2, name: 'Tambaram Water Board', score: '96.5%' },
    { rank: 3, name: 'Tambaram Sanitation', score: '95.8%' },
    { rank: 4, name: 'Tambaram Roads', score: '94.2%' },
    { rank: 5, name: 'Tambaram PWD', score: '93.5%' },
];

export default function PERMC20() {
