...
const departmentPerformance = [
    { name: 'Sanitation', resolved: 8, total: 11, satisfaction: 89, icon: 'cleaning_services', color: '#28c940', progressClass: 'pb-san' },
    { name: 'PWD', resolved: 4, total: 6, satisfaction: 86, icon: 'engineering', color: '#16aaff', progressClass: 'pb-pwd' },
    { name: 'Electricity', resolved: 6, total: 7, satisfaction: 92, icon: 'bolt', color: '#ffb300', progressClass: 'pb-elec' },
    { name: 'Water Supply', resolved: 8, total: 12, satisfaction: 80, icon: 'water_drop', color: '#ff792a', progressClass: 'pb-water' },
    { name: 'Roads', resolved: 8, total: 10, satisfaction: 83, icon: 'add_road', color: '#5e35b1', progressClass: 'pb-road' },
];
...
export default function ANAMC11() {
