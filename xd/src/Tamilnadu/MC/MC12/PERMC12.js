...
const kpis = [
    { label: 'SLA Compliance', value: '92.7%', change: '+0.9%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.0 hrs', change: '-0.2 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.6/5', change: '+0.1', trend: 'positive' },
    { label: 'Resolution Rate', value: '87.4%', change: '+0.8%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Thanjavur Electric', score: '97.2%' },
    { rank: 2, name: 'Thanjavur Water Board', score: '96.5%' },
    { rank: 3, name: 'Thanjavur Sanitation', score: '95.8%' },
    { rank: 4, name: 'Thanjavur Roads', score: '94.2%' },
    { rank: 5, name: 'Thanjavur PWD', score: '93.5%' },
];

export default function PERMC12() {
