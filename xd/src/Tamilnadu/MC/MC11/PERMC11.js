...
const kpis = [
    { label: 'SLA Compliance', value: '95.3%', change: '+1.4%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.8 hrs', change: '-0.3 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.7/5', change: '+0.2', trend: 'positive' },
    { label: 'Resolution Rate', value: '90.5%', change: '+1.3%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Vellore Electric', score: '97.2%' },
    { rank: 2, name: 'Vellore Water Board', score: '96.5%' },
    { rank: 3, name: 'Vellore Sanitation', score: '95.8%' },
    { rank: 4, name: 'Vellore Roads', score: '94.2%' },
    { rank: 5, name: 'Vellore PWD', score: '93.5%' },
];

export default function PERMC11() {
