...
export default function INTMC17() {
  ...
  <div className="bg-circle" style={{width:400,height:400,top:-100,left:-100,background:'#ae90ff',position:'fixed'}}></div>
      ...
      <main className="dashboard-main">
        ...
        <section className="card-grid">
          <div className="dashboard-card" onClick={() => navigate('/dbmc17')} style={{cursor:'pointer'}}>
            <span className="material-icons card-icon">dashboard</span>
            <div className="card-title">Dashboard</div>
            <div className="card-desc">Overview and main metrics</div>
          </div>
          <div className="dashboard-card" onClick={() => navigate('/dpmc17')} style={{cursor:'pointer'}}>
          ...
          <div className="dashboard-card" onClick={() => navigate('/mapmc17')}>
          ...
          <div className="dashboard-card" onClick={() => navigate('/anamc17')}>
          ...
          <div className="dashboard-card" onClick={() => navigate('/permc17')}>
