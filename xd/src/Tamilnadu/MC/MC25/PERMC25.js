...
const kpis = [
    { label: 'SLA Compliance', value: '92.4%', change: '+0.8%', trend: 'positive' },
    { label: 'Avg. First Response', value: '2.1 hrs', change: '-0.1 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.5/5', change: '+0.1', trend: 'positive' },
    { label: 'Resolution Rate', value: '87.9%', change: '+0.4%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Tiruvannamalai Electric', score: '97.2%' },
    { rank: 2, name: 'Tiruvannamalai Water Board', score: '96.5%' },
    { rank: 3, name: 'Tiruvannamalai Sanitation', score: '95.8%' },
    { rank: 4, name: 'Tiruvannamalai Roads', score: '94.2%' },
    { rank: 5, name: 'Tiruvannamalai PWD', score: '93.5%' },
];

export default function PERMC25() {
