...
const departmentPerformance = [
    { name: 'Sanitation', resolved: 7, total: 10, satisfaction: 89, icon: 'cleaning_services', color: '#28c940', progressClass: 'pb-san' },
    ...
    { name: 'Roads', resolved: 7, total: 9, satisfaction: 83, icon: 'add_road', color: '#5e35b1', progressClass: 'pb-road' },
];
...
export default function ANAMC13() {
