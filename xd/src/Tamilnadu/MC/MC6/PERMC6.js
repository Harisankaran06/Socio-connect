...
const kpis = [
    { label: 'SLA Compliance', value: '96.2%', change: '+1.7%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.7 hrs', change: '-0.4 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.8/5', change: '+0.2', trend: 'positive' },
    { label: 'Resolution Rate', value: '90.1%', change: '+1.1%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Tirunelveli Electric', score: '97.2%' },
    { rank: 2, name: 'Tirunelveli Water Board', score: '96.5%' },
    { rank: 3, name: 'Tirunelveli Sanitation', score: '95.8%' },
    { rank: 4, name: 'Tirunelveli Roads', score: '94.2%' },
    { rank: 5, name: 'Tirunelveli PWD', score: '93.5%' },
];

export default function PERMC6() {
