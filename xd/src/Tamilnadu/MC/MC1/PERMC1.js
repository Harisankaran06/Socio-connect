...
const kpis = [
    { label: 'SLA Compliance', value: '94.5%', change: '+1.2%', trend: 'positive' },
    ...
    { label: 'Resolution Rate', value: '88.1%', change: '-0.5%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Chennai Electric', score: '97.2%' },
    { rank: 2, name: 'Chennai Water Board', score: '96.5%' },
    { rank: 3, name: 'Chennai Sanitation', score: '95.8%' },
    { rank: 4, name: 'Chennai Roads', score: '94.2%' },
    { rank: 5, name: 'Chennai PWD', score: '93.5%' },
];

export default function PERTN() {
