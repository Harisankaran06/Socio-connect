...
const kpis = [
    { label: 'SLA Compliance', value: '96.8%', change: '+1.9%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.5 hrs', change: '-0.6 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.8/5', change: '+0.3', trend: 'positive' },
    { label: 'Resolution Rate', value: '91.7%', change: '+1.6%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Cuddalore Electric', score: '97.2%' },
    { rank: 2, name: 'Cuddalore Water Board', score: '96.5%' },
    { rank: 3, name: 'Cuddalore Sanitation', score: '95.8%' },
    { rank: 4, name: 'Cuddalore Roads', score: '94.2%' },
    { rank: 5, name: 'Cuddalore PWD', score: '93.5%' },
];

export default function PERMC13() {
