...
const departmentPerformance = [
    { name: 'Sanitation', resolved: 6, total: 9, satisfaction: 89, icon: 'cleaning_services', color: '#28c940', progressClass: 'pb-san' },
    { name: 'PWD', resolved: 4, total: 6, satisfaction: 86, icon: 'engineering', color: '#16aaff', progressClass: 'pb-pwd' },
    { name: 'Electricity', resolved: 5, total: 6, satisfaction: 92, icon: 'bolt', color: '#ffb300', progressClass: 'pb-elec' },
    { name: 'Water Supply', resolved: 7, total: 11, satisfaction: 80, icon: 'water_drop', color: '#ff792a', progressClass: 'pb-water' },
...
export default function ANAMC18() {
