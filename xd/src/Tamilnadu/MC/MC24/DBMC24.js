...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "29", change: "+3%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "5", change: "+1%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "10", change: "+2%", changeColor: "#e54f4a", className: "mc-progress" },
  { icon: "check_circle", title: "Resolved", value: "14", change: "+5%", changeColor: "#15bd60", className: "mc-resolved" },
  { icon: "trending_up", title: "Avg Resolution", value: "1.3d", change: "-0.2d", changeColor: "#15bd60", className: "mc-avg" },
  { icon: "error", title: "Overdue", value: "1", change: "+1", changeColor: "#e03434", className: "mc-overdue" }
];
...
const recentComplaints = [
    { desc: "Street light not working in Madurai Road", status: "Open" },
    { desc: "Sewage overflow in Vilangudi", status: "In Progress" },
    { desc: "Pothole on main road in Watrap", status: "Resolved" },
    { desc: "No water supply in Rajapalayam Road", status: "Open" }
];

export default function DBMC24() {
