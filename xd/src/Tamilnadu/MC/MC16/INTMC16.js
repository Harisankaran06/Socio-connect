...
export default function INTMC16() {
  ...
  <div className="bg-circle" style={{width:400,height:400,top:-100,left:-100,background:'#ae90ff',position:'fixed'}}></div>
      ...
      <main className="dashboard-main">
        ...
        <section className="card-grid">
          <div className="dashboard-card" onClick={() => navigate('/dbmc16')} style={{cursor:'pointer'}}>
            <span className="material-icons card-icon">dashboard</span>
            <div className="card-title">Dashboard</div>
            <div className="card-desc">Overview and main metrics</div>
          </div>
          <div className="dashboard-card" onClick={() => navigate('/dpmc16')} style={{cursor:'pointer'}}>
          ...
          <div className="dashboard-card" onClick={() => navigate('/mapmc16')}>
          ...
          <div className="dashboard-card" onClick={() => navigate('/anamc16')}>
          ...
          <div className="dashboard-card" onClick={() => navigate('/permc16')}>
