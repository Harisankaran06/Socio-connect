...
const kpis = [
    { label: 'SLA Compliance', value: '94.6%', change: '+1.3%', trend: 'positive' },
    { label: 'Avg. First Response', value: '1.8 hrs', change: '-0.2 hrs', trend: 'positive' },
    { label: 'Customer Satisfaction', value: '4.7/5', change: '+0.2', trend: 'positive' },
    { label: 'Resolution Rate', value: '89.8%', change: '+0.7%', trend: 'negative' },
];
...
const leaderboard = [
    { rank: 1, name: 'Sivakasi Electric', score: '97.2%' },
    { rank: 2, name: 'Sivakasi Water Board', score: '96.5%' },
    { rank: 3, name: 'Sivakasi Sanitation', score: '95.8%' },
    { rank: 4, name: 'Sivakasi Roads', score: '94.2%' },
    { rank: 5, name: 'Sivakasi PWD', score: '93.5%' },
];

export default function PERMC24() {
