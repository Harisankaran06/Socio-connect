...
const metrics = [
  { icon: "description", title: "Total Complaints", value: "56", change: "+8%", changeColor: "#15bd60", className: "mc-total" },
  { icon: "error_outline", title: "Open Complaints", value: "10", change: "+3%", changeColor: "#e1861e", className: "mc-open" },
  { icon: "schedule", title: "In Progress", value: "19", change: "+6%", changeColor: "#e54f4a", className: "mc-progress" },
...
const recentComplaints = [
    { desc: "Street light not working in GST Road", status: "Open" },
    { desc: "Sewage overflow in East Tambaram", status: "In Progress" },
    { desc: "Pothole on main road in Selaiyur", status: "Resolved" },
    { desc: "No water supply in Chitlapakkam", status: "Open" }
];

export default function DBMC20() {
